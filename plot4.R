# JHU Data Science - Course 04 - Exploratory Data Analysis - Assignment1 - Plot4
...
# Set plot matrix to 2x2
par(mfrow = c(2,2))

# Adjust vertical margins for slightly better aesthetics
par(mar = c(4,4,2,2))

# chart (1,1)
with(stripped_power_data, plot(datetime, Global_active_power, type= "l",
                               ylab = "Global Active Power",
                               xlab = ""))
# chart (1,2)
with(stripped_power_data, plot(datetime, Voltage, type= "l",
                               ylab = "Voltage",
                               xlab = "datetime"))
# chart (2,1)
...
legend("topright", 
       ...
       lty = "solid", col = c("black", "red", "blue"),
                              bty = "n")
# chart (2,2)
with(stripped_power_data, plot(datetime, Global_reactive_power, type= "l",
